 ...
 */
class getDrinkRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DrinkRepository' shared autowired service.
     *
     * @return \App\Repository\DrinkRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DrinkRepository.php';

        return $container->privates['App\\Repository\\DrinkRepository'] = new \App\Repository\DrinkRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
