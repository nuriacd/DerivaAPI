 ...
 */
class getRestaurantDrinkRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RestaurantDrinkRepository' shared autowired service.
     *
     * @return \App\Repository\RestaurantDrinkRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RestaurantDrinkRepository.php';

        return $container->privates['App\\Repository\\RestaurantDrinkRepository'] = new \App\Repository\RestaurantDrinkRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
