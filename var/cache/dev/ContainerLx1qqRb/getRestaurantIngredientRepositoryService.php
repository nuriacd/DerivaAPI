 ...
 */
class getRestaurantIngredientRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RestaurantIngredientRepository' shared autowired service.
     *
     * @return \App\Repository\RestaurantIngredientRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RestaurantIngredientRepository.php';

        return $container->privates['App\\Repository\\RestaurantIngredientRepository'] = new \App\Repository\RestaurantIngredientRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
